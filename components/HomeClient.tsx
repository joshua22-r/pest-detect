        ...
        <section className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/auth/register"
                className="inline-flex w-full items-center justify-center rounded-md bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 px-8 py-3 text-lg font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
                Get Started Free
              </Link>
              <Link
                href="/auth/login"
                className="inline-flex w-full items-center justify-center rounded-md border-2 border-green-600 bg-transparent px-8 py-3 text-lg font-semibold text-green-600 shadow-lg hover:bg-green-50 hover:shadow-xl transition-all duration-300"
              >
                Sign In
              </Link>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/predict"
                className="inline-flex w-full items-center justify-center rounded-md border border-white bg-transparent px-8 py-3 text-lg font-semibold text-white shadow-lg hover:bg-white hover:text-gray-900 hover:shadow-xl transition-all duration-300"
              >
                Try Demo
              </Link>
            </div>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex gap-4">
              <Link
                href="/predict"
                className="inline-flex items-center justify-center rounded-md bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 px-6 py-3 font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-300"
              >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Link
            href="/predict"
            className="block p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100 rounded-2xl"
          >
          ...
          <Link
            href="/history"
            className="block p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl"
          >
          ...
          <Link
            href="/profile"
            className="block p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100 sm:col-span-2 lg:col-span-1 rounded-2xl"
          >
          ...
          <Card className="p-8 border-0 shadow-lg bg-white rounded-2xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl">
                <div className="text-3xl font-bold text-green-600 mb-2">{stats.totalScans}</div>
                <p className="text-gray-600 font-medium">Total Scans</p>
              </div>
              <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                <div className="text-3xl font-bold text-blue-600 mb-2">{stats.plantScans}</div>
                <p className="text-gray-600 font-medium">Plant Scans</p>
              </div>
              <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl">
                <div className="text-3xl font-bold text-orange-600 mb-2">{stats.animalScans}</div>
                <p className="text-gray-600 font-medium">Animal Scans</p>
              </div>
              <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl">
                <div className="text-3xl font-bold text-purple-600 mb-2">{stats.commonDiseases.length}</div>
